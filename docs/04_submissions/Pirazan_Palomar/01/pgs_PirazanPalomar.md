...
I also want to speak about my learning process with the tutorial of _"Multiplication On A Circle With Modulo In Unreal"_. I tried to do it from scratch, which helped me understand better how to use the nodes. Unfortunately I was not able to connect the right points around the circle on my own, so I opened the completed scene. The interaction between modulo, mod and mult allowed me to get my final result in combination with the use of a cos function in replacement of one of the sin functions of the completed scene. The completed scene helped me understand better, even though the complexity was high, since I could not understand at the beginning the duplicated parts of the node web. I learned how math can be the base for new types of forms and I felt like a sculptor giving form with numbars and functions to a new being. I tried a lot of possibilities with the functions and the values until I got the final result, which I leked due to the 3d effect of the mesh, despite the fact that is is a 2d mesh. I think this is a complex topic but it is very nice to give birth to new artworks with the help of functions. I challenged myself by setting myself the goal of creating a form that would amaze me and generate interest and curiosity and it took a while but at the end I did it. 
