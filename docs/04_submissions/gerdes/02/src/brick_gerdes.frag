...
float BRICK_W = 0.3; // brick width
float BRICK_H = 0.1; // brick height
float MORTAR =  0.02; // mortar thickness
...
void main()
{
  ...
  float mortar_half_norm_w = (MORTAR * 0.5) / brick_mortar_w; // eg. 0.03125
  float mortar_half_norm_h = (MORTAR * 0.5) / brick_mortar_h; // eg. 0.08333
